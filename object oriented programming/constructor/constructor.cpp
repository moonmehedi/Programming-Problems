...
using namespace std;
class student
{ /*this element is private only fuction of this class will access them*/
    string name;
...
int main()
{
    /*constructor overloading means if there is multiple constructor
    then constructor will be called according to their number of arguments*/
    student a("moon", 22, 'm');
